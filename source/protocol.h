...
#ifdef TBB_IMBUING
    virtual void sendTextWindow(uint16_t itemId, std::string& text, std::string& writer, const uint16_t maxlen, const bool canWrite) = 0;
#endif // TBB_IMBUING
...
#ifdef TBB_IMBUING
    virtual void sendChannelsDialog(std::list<ChannelInfo> channels) = 0;
#endif //TBB_IMBUING
