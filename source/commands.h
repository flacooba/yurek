...
#ifdef TBB_IMBUING
    bool setStorageValue(Creature* c, const std::string &cmd, const std::string &param);
    bool getStorageValue(Creature* c, const std::string &cmd, const std::string &param);
#endif // TBB_IMBUING
