...
public:
	...
	#ifdef TBB_IMBUING
	bool OpenChannel(Player* player, uint16_t id);
	#endif //TBB_IMBUING
...
protected:
	...
	ActionVector onOpenChannelActions;
	#endif //TBB_IMBUING
...
#ifdef TBB_IMBUING
    bool executeOpenChannel(Player* player, uint16_t id);
#endif //TBB_IMBUING
...
#ifdef TBB_IMBUING
	static int luaActionGetPlayerTempValue(lua_State *L);
	static int luaActionSetPlayerTempValue(lua_State *L);
	static int luaActionDoPlayerSendChannelsDialog(lua_State *L);
	static int luaActionSetItemAttribute(lua_State *L);
	static int luaActionGetImbuementSlotsCount(lua_State *L);
	static int luaActionGetFreeImbuementSlotsCount(lua_State *L);
	static int luaActionGetFirstFreeImbuementSlotId(lua_State *L);
	static int luaActionSetImbuementSlotsCount(lua_State *L);
	static int luaActionGetThingPos(lua_State *L);
	static int luaActionGetPlayerInventoryItem(lua_State *L);
	static int luaActionHasItemImbuement(lua_State *L);
	static int luaActionSendPlayerTextWindow(lua_State *L);
	static int luaActionAddItemImbuement(lua_State *L);
#endif //TBB_IMBUING
